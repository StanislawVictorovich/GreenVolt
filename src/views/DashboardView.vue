<template>
    <section>
        ...
        <div class="metric-grid">
            ...
            <div class="metric-card"><span>Готовых товаров</span><strong>{{ productStats.inStock }}</strong></div>
        ...
        <div class="grid two">
            <BaseCard title="Срез по комплектующим" description="В наличии, в заказе, в непроданном оборудовании.">
                <EntityTable :rows="componentRows" :columns="componentColumns" />
            </BaseCard>
            <BaseCard title="Срез по товарам" description="В наличии, в броне, продано.">
